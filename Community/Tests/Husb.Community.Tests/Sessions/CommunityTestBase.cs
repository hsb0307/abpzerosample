...
namespace Husb.Community.Tests.Sessions
{
    public abstract class CommunityTestBase : AbpIntegratedTestBase
    {
        protected CommunityTestBase()
        {
        ...
        protected override void AddModules(ITypeList<AbpModule> modules)
        {
            ...
            modules.Add<CommunityApplicationModule>();
            modules.Add<CommunityDataModule>();
        }

        public void UsingDbContext(Action<CommunityDbContext> action)
        {
            using (var context = LocalIocManager.Resolve<CommunityDbContext>())
            {
        ...
        public T UsingDbContext<T>(Func<CommunityDbContext, T> func)
        {
            T result;
